...
@return []Event
*/
func (a *EventsApiService) ListEvents(ctx _context.Context) ([]Event, *_nethttp.Response, error) {
	var (
...
func (a *EventsApiService) ReadEvent(ctx _context.Context, event string) (Event, *_nethttp.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"event"+"}", _neturl.QueryEscape(parameterToString(event, "")) , -1)
